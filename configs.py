...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','149.102.231.114') else APP_NAME+'.herokuapp.com'
...
MULTI_CLIENT = False
name = str(environ.get('name', 'ZinFlix'))
...
STREAM_LOGS = environ.get('STREAM_LOGS','-1001826781136')
...
class Config(object):
	...
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001826781136")
